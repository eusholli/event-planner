            ...
            <div className={`card sticky top-24 max-h-[calc(100vh-8rem)] overflow-y-auto ${isLinking ? 'border-2 border-green-500' : ''}`}>
                ...
                >
                    <div className="flex justify-between flex-grow items-center">
                        <h2 className="text-xl font-bold tracking-tight text-zinc-900 mb-0">
                            {isLinking ? 'Link Existing Attendee' : 'Add Attendee'}
                        </h2>
                        {isLinking && (
                            <button
                                type="button"
                                onClick={(e) => { e.stopPropagation(); setIsLinking(false); setFormData({ ...formData, name: '' }); }}
                    ...
                    <div className="lg:hidden text-zinc-400 ml-2">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className={`btn-primary disabled:opacity-50 disabled:cursor-not-allowed px-6 ${isLinking ? 'w-full' : ''}`}
                            >
