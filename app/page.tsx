    ...
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center space-y-8">
      ...
      <div className="pt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-left max-w-5xl mx-auto px-4">
        ...
        <div className="p-6 bg-white rounded-2xl border border-zinc-100 shadow-sm hover:shadow-md transition-shadow">
          ...
          <h3 className="text-lg font-bold text-zinc-900 mb-2">OpenClaw Insights</h3>
          <p className="text-zinc-500">Get market intelligence from a dedicated AI agent that understands your event context. Ask questions, generate reports, and download insights as PDFs.</p>
        </div>

        {/* Card 2: AI Auto-Complete */}
        <div className="p-6 bg-white rounded-2xl border border-zinc-100 shadow-sm hover:shadow-md transition-shadow">
          <div className="w-12 h-12 bg-indigo-50 rounded-xl flex items-center justify-center mb-4 text-indigo-600">
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
          </div>
          <h3 className="text-lg font-bold text-zinc-900 mb-2">AI-Powered Auto Complete</h3>
          <p className="text-zinc-500">Type a name and company, and the system builds a complete attendee profile — title, bio, and LinkedIn — powered by Google Gemini.</p>
        </div>

        {/* Card 3: Multi-Event Portfolio */}
        <div className="p-6 bg-white rounded-2xl border border-zinc-100 shadow-sm hover:shadow-md transition-shadow">
          <div className="w-12 h-12 bg-indigo-50 rounded-xl flex items-center justify-center mb-4 text-indigo-600">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
          </div>
          <h3 className="text-lg font-bold text-zinc-900 mb-2">Multi-Event Command Center</h3>
          <p className="text-zinc-500">Manage your entire event portfolio with list, calendar, and map views. Track status, export briefing books, and control access — all from one dashboard.</p>
        </div>
      </div>
    </div >
  )
