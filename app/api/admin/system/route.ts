...
async function handlePOST(request: Request, ctx: { params: Promise<Record<string, string>>; authCtx: AuthContext }) {
    try {
        ...
        const { geminiApiKey, defaultTags, defaultMeetingTypes, defaultAttendeeTypes, defaultRegionTypes, defaultContentTypes, contentTypeColors, maintenanceMode, brandVoice } = json
        ...
        const data = {
            ...
            brandVoice: typeof brandVoice === 'string' ? brandVoice : null
        }
