...
export default function NewMeetingPage() {
    ...
    return <NewMeetingContent eventId={id} />
}

function NewMeetingContent({ eventId }: { eventId: string }) {
    ...
    useEffect(() => {
        ...
        Promise.all([
        ...
        ]).then(([attendeesData, roomsData, eventData]) => {
            ...
            if (eventData) {
                ...
                setFormData(prev => ({
                    ...prev,
                    date: prev.date || eventData.startDate.split('T')[0] || '',
        ...
        <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-1">
                    <AddAttendeeForm onSuccess={handleNewAttendee} eventId={eventId} />
                </div>
