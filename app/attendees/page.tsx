...
export default function AttendeesPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                setFormData({ name: '', email: '', company: '', bio: '', companyDescription: '', linkedin: '' })
                fetchAttendees()
            }
        } catch (error) {
    ...
    const generateBriefing = async (attendee: Attendee) => {
        ...
        try {
            ...
            doc.setFontSize(12)
            doc.text(`${attendee.company}`, 14, 28)
                ...
                <div className="lg:col-span-2">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {attendees.map((attendee) => (
                            <div key={attendee.id} className="card hover:border-zinc-200 group relative">
                                <div className="flex items-start justify-between mb-3">
                                    <div>
                                        ...
                                        <p className="text-sm text-zinc-500 font-medium">{attendee.company}</p>
                                    </div>
                                ...
                                <p className="text-sm text-zinc-600 line-clamp-3 leading-relaxed">{attendee.bio || 'No bio available'}</p>
                                {attendee.linkedin && (
                                    <a href={attendee.linkedin} target="_blank" rel="noopener noreferrer" className="mt-3 inline-flex items-center text-xs font-medium text-indigo-600 hover:text-indigo-700">
