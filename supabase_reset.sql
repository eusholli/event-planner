/*
  SUPABASE FULL RESET SCRIPT
  --------------------------
  Copy and paste this entire file into the Supabase SQL Editor to:
  1. Wipe all existing data and tables (Event, Attendee, Meeting, Room, SystemSettings).
  2. Re-create the database schema exactly as defined in your local project.

  WARNING: THIS DELETES ALL DATA.
*/

-- 1. DROP EXISTING TABLES AND TYPES
DROP TABLE IF EXISTS "_AttendeeMeetings" CASCADE;
DROP TABLE IF EXISTS "Meeting" CASCADE;
DROP TABLE IF EXISTS "Room" CASCADE;
DROP TABLE IF EXISTS "Attendee" CASCADE;
DROP TABLE IF EXISTS "Event" CASCADE;
DROP TABLE IF EXISTS "SystemSettings" CASCADE;
DROP TABLE IF EXISTS "_prisma_migrations" CASCADE; -- Optional: resets migration history
